  ...
  return (
    <Menu>
      ...
      >
        ...
        <ExcelExportColumn field="gestor.nombre" title="Gestor Asignado" width={250} headerCellOptions={headerOptions}/>
        <ExcelExportColumn field="tecnico.auditor.apellidos" title="Auditor" width={250} headerCellOptions={headerOptions}/>
